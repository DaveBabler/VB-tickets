Public Class LabelManipulation
    Public Shared Sub CheckLabelVisibility(Container As Control, Value As String, ByRef blCurrentState As Boolean, ByRef blDesiredState As Boolean)
        ...
        For Each C As Control In Container.Controls
            ...
            ElseIf C.HasChildren Then
                CheckLabelVisibility(C, Value, blCurrentState, blDesiredState)
            End If
